...
class UndoMacroStackProtocol(Protocol):
...
class TabMutationGatewayProtocol(Protocol):
    ...
    @property
    def undo_stack(self) -> UndoMacroStackProtocol | None: ...
...
class TabBootstrapProtocol(TabMutationGatewayProtocol, TabValidationViewProtocol, TabSetupProtocol, Protocol):
    _navigation: Any
    _editability: Any
