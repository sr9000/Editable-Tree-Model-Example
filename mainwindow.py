...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.viewExpandAllAction.setObjectName(u"viewExpandAllAction")
        self.viewCollapseAllAction = QAction(MainWindow)
        self.viewCollapseAllAction.setObjectName(u"viewCollapseAllAction")
        self.viewZoomInAction = QAction(MainWindow)
        self.viewZoomInAction.setObjectName(u"viewZoomInAction")
        self.viewZoomOutAction = QAction(MainWindow)
        self.viewZoomOutAction.setObjectName(u"viewZoomOutAction")
        self.viewResetZoomAction = QAction(MainWindow)
        self.viewResetZoomAction.setObjectName(u"viewResetZoomAction")
...
#endif // QT_CONFIG(shortcut)
        self.viewExpandAllAction.setText(QCoreApplication.translate("MainWindow", u"Expand All", None))
        self.viewCollapseAllAction.setText(QCoreApplication.translate("MainWindow", u"Collapse All", None))
        self.viewZoomInAction.setText(QCoreApplication.translate("MainWindow", u"Zoom In", None))
#if QT_CONFIG(shortcut)
        self.viewZoomInAction.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl++", None))
#endif // QT_CONFIG(shortcut)
        self.viewZoomOutAction.setText(QCoreApplication.translate("MainWindow", u"Zoom Out", None))
#if QT_CONFIG(shortcut)
        self.viewZoomOutAction.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+-", None))
#endif // QT_CONFIG(shortcut)
        self.viewResetZoomAction.setText(QCoreApplication.translate("MainWindow", u"Reset Zoom", None))
#if QT_CONFIG(shortcut)
        self.viewResetZoomAction.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+0", None))
#endif // QT_CONFIG(shortcut)
