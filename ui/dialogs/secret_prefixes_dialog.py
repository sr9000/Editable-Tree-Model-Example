...
class Ui_SecretPrefixesDialog(object):
    def setupUi(self, SecretPrefixesDialog):
        if not SecretPrefixesDialog.objectName():
            SecretPrefixesDialog.setObjectName(u"SecretPrefixesDialog")
    ...
    def retranslateUi(self, SecretPrefixesDialog):
        SecretPrefixesDialog.setWindowTitle(QCoreApplication.translate("SecretPrefixesDialog", u"Secret word prefixes", None))
        self.addButton.setText(QCoreApplication.translate("SecretPrefixesDialog", u"Add", None))
        self.editButton.setText(QCoreApplication.translate("SecretPrefixesDialog", u"Edit", None))
        self.removeButton.setText(QCoreApplication.translate("SecretPrefixesDialog", u"Remove", None))
    # retranslateUi
