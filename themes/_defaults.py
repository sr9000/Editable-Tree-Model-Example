...
_LIGHT_TYPES: dict[JsonType, TypeStyle] = {
    ...
    JsonType.SECRET_LINE: TypeStyle(fg=_c("#946f00")),
    JsonType.SECRET_TEXT: TypeStyle(fg=_c("#946f00"), italic=True),
...
_DARK_TYPES: dict[JsonType, TypeStyle] = {
    ...
    JsonType.SECRET_LINE: TypeStyle(fg=_c("#e0af68")),
    JsonType.SECRET_TEXT: TypeStyle(fg=_c("#e0af68"), italic=True),
