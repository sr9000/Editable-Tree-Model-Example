...
| 02 | [`02-number-affix.md`](02-number-affix.md) | Integers and floats with a textual prefix **or** suffix (never both); stored as string; optional space between affix and number is preserved. |
