...
@pytest.mark.parametrize(
    ...
    [
        ...
        # datetime
        ("2025-11-02 12:34:56", DateTimeCategory.DateTime, datetime(2025, 11, 2, 12, 34, 56)),
        # tdatetime
        ("2025-11-02T12:34:56", DateTimeCategory.DateTime, datetime(2025, 11, 2, 12, 34, 56)),
        # datetime+ms
        ("2025-11-02 12:34:56.123", DateTimeCategory.DateTime, datetime(2025, 11, 2, 12, 34, 56, 123000)),
        # tdatetime+ms
        ("2025-11-02T12:34:56.123456", DateTimeCategory.DateTime, datetime(2025, 11, 2, 12, 34, 56, 123456)),
        # datetime+tz
        (
        ...
        # arbitrary separator
        ("2025-11-02_12:34:56", DateTimeCategory.DateTime, datetime(2025, 11, 2, 12, 34, 56)),
        # utc
        (
