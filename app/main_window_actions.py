...
def update_actions(window):
    ...
    can_edit = bool(tab and not tab.data_store.is_read_only)
    ...
    window.fileSaveAction.setEnabled(has_tab and can_edit and tab.data_store.is_dirty)
    window.fileSaveAsAction.setEnabled(has_tab and can_edit)
    window.fileReloadAction.setEnabled(has_tab and can_edit and bool(tab.data_store.file_path))
    window.fileCopyPathAction.setEnabled(bool(tab and tab.data_store.file_path))
